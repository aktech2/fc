...
using Cymax.Grabber.Api1Manager.Models.Requests;
using Cymax.Grabber.Api1Manager.Models.Responses;
using Cymax.Grabber.CommonUtils;
using Cymax.Grabber.Entities.Interfaces;
using Cymax.Grabber.Entities.Models.Common;
using Microsoft.Extensions.Configuration;

namespace Cymax.Grabber.Api1Manager;
...
internal class Api1Manager: IBaseApiManager
{
    ...
    /// The request URL.
    /// </value>
    private string _requestUrl => _configuration[Api1RequestUrlConfigurationRootName];

    /// <summary>
    /// The API1 request URL configuration root name
    /// </summary>
    private const string Api1RequestUrlConfigurationRootName = "Api1RequestUrl";
